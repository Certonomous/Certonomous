...
_CLOSURE = {
    ...
    "our_entry": "Entry of record (round 5, 2026-08-07) scored 0.0566 overall through the "
                 ...
                 "same. THAT COUNT IS SUPERSEDED AS OF 2026-08-11 and is kept only so the "
                 "correction is visible: it was measured against the FOUR-entry board. "
                 "Against the live six-entry board the count is TWO of the eight, both "
                 "alpha_15 hills having been lost to Tian, Buchanan, Hickel and Dwight - and "
                 "the two that survive are exactly the two organisers' baseline rows, so the "
                 "count belonging to our own model is ZERO of eight. Our model is best on no "
                 "single case. The overall is a mean and not a count of wins, so 0.0566 is "
