...
Usage:
    python3 check_k0d_mesh.py --case <case dir> --level L1|L2|L3
    python3 check_k0d_mesh.py --root <K0d_runs dir>      # all present cases
    python3 check_k0d_mesh.py --selftest
"""
import argparse
import os
import re
...
LEVELS = {
    ...
    "L2": dict(Nx=224, nA=17, nB=193, nC=14, Ny=224, cells=50176,
...
def selftest():
    print("=" * 74)
    print("check_k0d_mesh.py -- SELFTEST (planted controls)")
    print("=" * 74)
    fails = []
