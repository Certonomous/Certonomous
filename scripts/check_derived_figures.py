...
_REL = lambda p: str(p.relative_to(lab_paths.REPO))  # noqa: E731

SOURCES = {
    "seed": (_REL(lab_paths.web_file(
        "closure_challenge_seed_sensitivity.json")), "json"),
    "qcr": (_REL(lab_paths.web_file(
        "closure_challenge_round5_qcr.json")), "json"),
    "board": ("sdk/scripts/probability_of_rank.py", "LIVE_BOARD"),
    "rank": ("sdk/scripts/probability_of_rank_record.json", "json"),
    "floor": (_REL(lab_paths.web_file(
        "closure_challenge_rans_floor.json")), "json"),
}
