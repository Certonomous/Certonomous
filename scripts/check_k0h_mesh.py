...
Usage:
    python3 check_k0h_mesh.py --case <case dir> --level L1|L2|L3
    python3 check_k0h_mesh.py --root <K0h_runs dir>      # all present cases
    python3 check_k0h_mesh.py --selftest
"""
...
#     scripts/check_k0g_mesh.py
#     git blob 39e55f2d4da55943c529257403cfd26190cb41e0
...
SELF_REL = "scripts/check_k0h_mesh.py"
GRADING_PATH = (
...
def selftest():
    print("=" * 74)
    print("check_k0h_mesh.py -- SELFTEST (planted controls)")
    print("=" * 74)
    fails = []
