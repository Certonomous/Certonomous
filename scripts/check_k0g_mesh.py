...
Usage:
    python3 check_k0g_mesh.py --case <case dir> --level L1|L2|L3
    python3 check_k0g_mesh.py --root <K0g_runs dir>      # all present cases
    python3 check_k0g_mesh.py --selftest
"""
import argparse
import os
import re
...
def selftest():
    print("=" * 74)
    print("check_k0g_mesh.py -- SELFTEST (planted controls)")
    print("=" * 74)
    fails = []
