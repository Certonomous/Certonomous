"""G-CPUSET reading for the chain driver (D17, new in this family; the aggregate-memory
...
usage: d17_cpuset_overlap.py <registered cpuset, e.g. 12,15> <own prefix, e.g. d17_>"""
import json
import subprocess
import sys
