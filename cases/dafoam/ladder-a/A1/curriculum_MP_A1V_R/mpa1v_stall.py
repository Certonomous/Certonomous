#!/usr/bin/env python3
"""MP-A1 STALL DETECTOR -- the registered numerical stop for a backtracking optimiser.
...
`NOT A RESULT` lives in `mpa1_grade.py` and is section 9's, not this module's --
...
def selftest():
    ok = True
    print("MP-A1 STALL DETECTOR SELFTEST")
...
def main(argv):
    ...
    if len(argv) >= 3 and argv[1] == "scan":
        ...
        return 0
    print(__doc__)
    print("usage: mpa1_stall.py scan <ipopt_output_file>\n"
          "       mpa1_stall.py selftest")
    return 1
