...
| reading | value |
|---|---|
| `PREREGISTRATION.md` immediately before this append | **861 lines, 57,491 bytes**, md5 `d527722d513233e53654470cd0faa510` |
| first 57,491 bytes of the result, compared to the whole pre-append document with `cmp` | **IDENTICAL — cmp silent, rc = 0** |
| first 861 lines of the result, compared to the whole pre-append document with `cmp` | **IDENTICAL — cmp silent, rc = 0** |
| line number of all `## ` headings, before vs after | **all 16 at IDENTICAL line numbers** |
...
reports **rc = 1, `differ: byte 20775, line 298`**: it names the mutated line exactly. A comparison
