#!/usr/bin/env python3
r"""Curriculum D19O -- THE IPOPT LOG READER AND THE REGISTERED NUMERICAL STOP.
...
Usage:  d19o_stall.py --selftest
        d19o_stall.py --calibrate <opt_IPOPT.txt> [...]
...
def selftest():
    ...
    print("D19O STALL DETECTOR -- CONTROLS")
    ...
    print()
    print("D19O STALL SELFTEST: %s" % ("OK -- every red leg fired" if ok else "FAILED"))
...
if __name__ == "__main__":
    ...
    sys.stderr.write("Usage: d19o_stall.py --selftest | --calibrate <opt_IPOPT.txt>...\n")
    sys.exit(64)
