...
Self-test: `python3 d6rf_units_assert.py --selftest` drives mutants AND the two
...
RS_D4 = os.path.abspath(os.path.join(HERE, os.pardir, "curriculum_D4",
                                     "d4_opt_runScript.py"))
RS_D6R = os.path.abspath(os.path.join(HERE, os.pardir, "curriculum_D6R",
...
def main():
    ...
    if not a.dvfile or not a.runscript:
        sys.stderr.write("usage: d6rf_units_assert.py <dvfile> --runscript "
