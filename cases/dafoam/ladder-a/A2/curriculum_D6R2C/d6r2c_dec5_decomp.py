...
RECORD = "d6r2c_dec5.jsonl"   # D6R2C-AFTER8-R3: the ONLY change from d6r2c_dec4_decomp.py
...
def selftest():
    ...
    try:
        ...
        check("the record file is the successor's own", RECORD, "d6r2c_dec5.jsonl")
    finally:
        shutil.rmtree(tmp, ignore_errors=True)
    print("D6R2C_DEC5_DECOMP SELFTEST %s n=%d" % ("PASS" if ok else "FAIL", n))
