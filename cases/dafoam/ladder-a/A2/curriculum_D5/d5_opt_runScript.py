...
# D5 REGISTERED DELTA (the only one): the FFD box is an argument, default = D4's own file
parser.add_argument("-ffd", help="FFD box file (D5 density delta)", type=str, default="FFD/wingFFD.xyz")
...
class Top(Multipoint):
    def setup(self):
        ...
        self.add_subsystem("geometry", OM_DVGEOCOMP(file=args.ffd, type="ffd"))
