...
# ===========================================================================
ITEM=D6R
REGISTERED_BASE=/home/ubuntu/certonomous-runs/CURRICULUM-D6R-a2-wing-multipoint
...
LIVE_SAME_ARM=$(sudo -n docker ps --format '{{.Names}}' --filter "name=^d6r_${ARM}_" 2>/dev/null | grep "^d6r_${ARM}_" | head -3 | tr '\n' ',' | sed 's/,$//')
