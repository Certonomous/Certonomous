...
mechanically rather than promised in prose:
  ...
  LIMIT 1  The repair is NOT FROZEN until one primal at the corrected design
           ...
           BEFORE the run.  That is `d7f_accept_primal.py` and
           `d7f_accept_compare.py`, and this file is useless without them.
...
import d7f_endpoint_locus as locus                                  # noqa: E402
...
def refuse(msg):
    sys.stderr.write("D7F_ENDPOINT_PHYSICAL REFUSE %s\n" % msg)
    sys.exit(2)
...
def main():
    ...
    sys.stdout.write("D7F_ENDPOINT_PHYSICAL_WRITTEN %s scalers=%s "
