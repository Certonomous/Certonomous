"""G-CPUSET reading for the chain driver (D18, new in this family; the aggregate-memory
...
usage: d18_cpuset_overlap.py <registered cpuset, e.g. 12,15> <own prefix, e.g. d18_>"""
import json
import subprocess
import sys
