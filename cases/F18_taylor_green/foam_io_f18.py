#!/usr/bin/env python3
"""F18 -- minimal reader/writer for OpenFOAM ascii volVectorField / volScalarField
files, used by build_f18.py (to write 0/U from the mesh's own 0/C) and by
grade_f18.py (to read U at every checkpoint).  Refusals are `raise`; zero
`assert` (L-332)."""
import re
