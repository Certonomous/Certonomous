...
import exact_f17 as EX            # noqa: E402
import foam_io_f17 as FIO          # noqa: E402
...
def die(msg, rc=1):
    sys.stderr.write("ABORT (build_f17): %s\n" % msg)
    sys.exit(rc)
...
def main(argv):
    if len(argv) != 3 or argv[1] != "--level":
        die("usage: build_f17.py <dest_dir> --level <coarse|medium|fine>")
