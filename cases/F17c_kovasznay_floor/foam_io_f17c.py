#!/usr/bin/env python3
"""F17 -- minimal reader/writer for OpenFOAM ascii volVectorField / volScalarField
files, used by build_f17c.py (to write 0/U from the mesh's own 0/C) and by
grade_f17c.py (to read U at every checkpoint).  Refusals are `raise`; zero
`assert` (L-332)."""
import re
