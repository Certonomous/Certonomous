...
> **NOT FILED — BLOCKED, 2026-08-23.** Two docket rows, drafted and ready, that
> **could not be appended to `docs/DOCKET.md`** on the day they were written.
> The blocker is not this lane's to clear and is described in full below. This
> file is the durable draft (`CLAUDE.md` rule 13: a draft another agent must
> read lives under the case directory it belongs to, never in a scratchpad).
> The sibling `DOCKET_DRAFT.md` is stamped FILED and was **not** appended to.
