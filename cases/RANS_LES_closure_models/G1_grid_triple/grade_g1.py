"""G1 comparator: strict completion, planted-disk controls, refinement-family
control, Roache triple classification and GCI.

It reads only from disk, launches nothing, and touches no git index.

Standing-rule compliance carried here:
  rule 3  planted zero -- three controls, each of which WRITES A REAL FILE,
          ...
          does not satisfy this rule and none is used.
...
def grade(run_root=RUN_ROOT):
    ...
    print("=" * 78)
    print("G1 GRID TRIPLE -- comparator  (DRAFT, NOT FROZEN)")
