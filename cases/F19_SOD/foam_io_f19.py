#!/usr/bin/env python3
"""F19 -- minimal reader/writer for OpenFOAM ascii volVectorField / volScalarField
files (lineage: cases/F18_taylor_green/foam_io_f18.py, plus a scalar plant), used by
build_f19.py (to write 0/p, 0/T, 0/U from the mesh's own 0/C) and by
grade_f19.py (to read rho and U at endTime).  Refusals are `raise`; zero
`assert` (L-332)."""
import re
