#!/usr/bin/env python3
"""F24 -- minimal reader/writer for OpenFOAM ascii volVectorField / volScalarField
files (lineage: cases/F20_ISENTROPIC_VORTEX/foam_io_f20.py), used by
build_f24.py (to write 0/p, 0/T, 0/U from the mesh's own 0/C) and by
grade_f24.py (to read p, T, U at every checkpoint and 0/C, 0/V).  Refusals are `raise`; zero
`assert` (L-332)."""
import re
