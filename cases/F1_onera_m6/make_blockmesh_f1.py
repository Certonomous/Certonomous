...
sys.path.insert(0, os.path.abspath(os.path.join(HERE, "..", "F13_onera_m6")))
from m6_section import M6Geometry  # noqa: E402

BETA_N, BETA_NOSE = 10.575549, np.log(12.5)
C_ROOT_REG = 0.8059
R = XEXIT = 20.0 * C_ROOT_REG
U1, U2, CORE_S = 0.10, 0.90, 0.50
NPL = 80
...
class Gen:
    ...
    def geom(self):
        for zi in range(3):
            ...
            if zi >= 1:
                self.V_(("mle", zi), (xa, 0, z)); self.V_(("mte", zi), (xb, 0, z))
                for s, t in ((1, "up"), (-1, "lo")):
