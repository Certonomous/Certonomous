#!/usr/bin/env python3
"""F20 -- minimal reader/writer for OpenFOAM ascii volVectorField / volScalarField
files (lineage: cases/F19_SOD/foam_io_f19.py), used by
build_f20.py (to write 0/p, 0/T, 0/U from the mesh's own 0/C) and by
grade_f20.py (to read rho and U at endTime).  Refusals are `raise`; zero
`assert` (L-332)."""
import re
