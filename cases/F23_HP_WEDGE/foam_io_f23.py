#!/usr/bin/env python3
"""F23 -- minimal reader/writer for OpenFOAM ascii volVectorField / volScalarField
files (lineage: cases/F20_ISENTROPIC_VORTEX/foam_io_f20.py), used by
build_f23.py (to write 0/U from the mesh's own 0/C) and by
grade_f23.py (to read U at every checkpoint and 0/C, 0/V).  Refusals are `raise`; zero
`assert` (L-332)."""
import re
