#!/usr/bin/env python3
"""mutation_test_vmfl011.py -- proves the VMFL011 comparator's controls are REAL and
...
drives grade_vmfl011.py as a subprocess under BOTH interpreters and checks:
...
GRADER = os.path.join(HERE, 'grade_vmfl011.py')
...
def main():
    ...
    print('--- mutation_test_vmfl011.py')
