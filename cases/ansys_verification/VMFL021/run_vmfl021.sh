...
PREREG="cases/ansys_verification/VMFL021/PREREGISTRATION.md"
COMPARATOR="cases/ansys_verification/VMFL021/grade_vmfl021.py"
CASE_SRC="${REPO}/cases/ansys_verification/VMFL021/case"
FOAM_BASHRC="/usr/lib/openfoam/openfoam2606/etc/bashrc"
RANKS=1                       # serial: keeps the core-minute cost measurement clean

if [ "$SMOKE" -eq 1 ]; then
  RUN_ROOT="/tmp/claude-1000/-home-ubuntu-Certonomous/64b13819-ff95-4d4d-a50f-3720bab19084/scratchpad/vmfl021_smoke_run"
...
echo "  python3 cases/ansys_verification/VMFL021/grade_vmfl021.py"
