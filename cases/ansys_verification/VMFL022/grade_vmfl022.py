#!/usr/bin/env python3
"""VMFL022 comparator -- Cavitation over a sharp-edged orifice, Case B (low P1).
...
GATE QUANTITY: coefficient of discharge
  ...
  python3 grade_vmfl022.py            # grade the run tree
  python3 grade_vmfl022.py --selftest # synthetic, no solver
  python3 grade_vmfl022.py --dryrun-reader <surfaceFieldValue.dat>
"""
...
# manual Table .22.1
CD_REF = 0.780         # THE GATE reference (Nurick)
...
OUT_JSON = os.path.join(RUN_ROOT, "GRADING_VMFL022.json")
