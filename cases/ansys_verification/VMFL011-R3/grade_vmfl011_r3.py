#!/usr/bin/env python3
"""grade_vmfl011_r3.py -- comparator for VMFL011-R3, Laminar Flow in a Triangular
...
def frozen_constants_control():
    ...
    return {'checked': 13, 'reference_blob': got_blob, 'n_bench': len(by),
...
def main():
    ...
    R = {'case': 'VMFL011-R3', 'manual_page': 41, 'endTime': ENDTIME,
    ...
    out = a.out or os.path.join(a.run_root, 'GRADING_VMFL011_R3.json')
