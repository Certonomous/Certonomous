#!/usr/bin/env bash
# ============================================================================
# run_vmflgpu007.sh -- VMFLGPU007 graded-run driver.
#
...
#
# IT GRADES NOTHING.  Grading is grade_vmflgpu007.py, frozen separately and
...
#
# EXECUTE this script (`bash run_vmflgpu007.sh <run_root>`); NEVER `source` it.
# ============================================================================
...
LEVELS="L1:16:96:24:10:1200:3648 L2:24:144:36:12:1800:7776 L3:36:216:52:14:3000:16128"
H1_WALL=0.07
...
RUN_ROOT="${1:?usage: run_vmflgpu007.sh <run_root>}"
...
CASE_REL_DIR="cases/ansys_verification/VMFLGPU007"
PREREG_REL="$CASE_REL_DIR/PREREGISTRATION.md"
GRADER_REL="$CASE_REL_DIR/grade_vmflgpu007.py"
LAUNCHER_REL="$CASE_REL_DIR/run_vmflgpu007.sh"
