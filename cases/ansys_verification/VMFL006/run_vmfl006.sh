#!/usr/bin/env bash
# VMFL006 graded-run driver -- Multicomponent Species Transport in Pipe Flow
...
# PREREGISTRATION.md sec.12. AN OVERRUN STOPS THE RUN; IT GETS NO NEW BUDGET.
#
...
PREREG_REL="cases/ansys_verification/VMFL006/PREREGISTRATION.md"
GRADER_REL="cases/ansys_verification/VMFL006/grade_vmfl006.py"
MAKEU_REL="cases/ansys_verification/VMFL006/make_u_vmfl006.py"
if [ "$MODE" = "smoke" ]; then
