...
#
# usage:  run_vmfl076.sh <graded|smoke> <L1|L2|L3>
# ===========================================================================
REPO=/home/ubuntu/Certonomous
CASE=$REPO/cases/ansys_verification/VMFL076
RUNROOT=$REPO/verification/runs/ansys_verification/VMFL076
SCRATCH=/tmp/claude-1000/-home-ubuntu-Certonomous/64b13819-ff95-4d4d-a50f-3720bab19084/scratchpad
PREREG=cases/ansys_verification/VMFL076/PREREGISTRATION.md
GRADER=cases/ansys_verification/VMFL076/grade_vmfl076.py
RANKS=1
...
case "$LEVEL" in
  L1) NX=160; NY=60;  ENDTIME=2000; WRITEINTERVAL=250; SAMPLEINTERVAL=50; CAP=10  ;;
  L2) NX=320; NY=120; ENDTIME=3000; WRITEINTERVAL=375; SAMPLEINTERVAL=50; CAP=30  ;;
  L3) NX=640; NY=240; ENDTIME=5000; WRITEINTERVAL=625; SAMPLEINTERVAL=50; CAP=150 ;;
  *) echo "ABORT: level must be L1, L2 or L3 (got '$LEVEL')"; exit 1 ;;
esac
GY=200
