#!/usr/bin/env bash
# ============================================================================
# run_vmflgpu001.sh -- VMFLGPU001 graded-run driver.
#
...
#
# EXECUTE this script (`bash run_vmflgpu001.sh <run_root>`); NEVER `source` it.
# ============================================================================
...
RUN_ROOT="${1:?usage: run_vmflgpu001.sh <run_root>}"
BUILD_ROOT="${BUILD_ROOT:-$HOME/gpu_build}"
REPO="${REPO:-$HOME/Certonomous}"
PREREG_REL="cases/ansys_verification/VMFLGPU001/PREREGISTRATION.md"
GRADER_REL="cases/ansys_verification/VMFLGPU001/grade_vmflgpu001.py"
