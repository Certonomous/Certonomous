...
SELF_REL = "cases/ansys_verification/VMFL045/grade_vmfl045.py"
RUN_ROOT = os.path.join(REPO, "verification/runs/ansys_verification/VMFL045")
OUT_JSON = os.path.join(RUN_ROOT, "GRADING_VMFL045.json")
