...
# PRINCIPAL RISK (prereg sec.7): exact junction geometry pending archive extraction;
# a smoke build of this geometry gave split 0.921 vs target 0.887.
set -u
...
declare -A N=( [L1]=20 [L2]=40 [L3]=80 )  N3=( [L1]=60 [L2]=120 [L3]=240 )
...
for L in L1 L2 L3; do
  ...
  sed -e "s/__N3__/${N3[$L]}/g" -e "s/__N__/${N[$L]}/g" \
