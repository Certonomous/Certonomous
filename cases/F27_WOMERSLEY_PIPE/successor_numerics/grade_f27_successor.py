...
import exact_f27 as EX                  # THE EXACT SOLUTION and the discretisation model (SHARED, unchanged).
...
CAP_CORE_MIN = 500.0                    # HARD CAP, F27_NUMERICS_SUCCESSOR_PREREGISTRATION.md section 5;
...
def main(argv=None):
    ...
    census = ast_no_asserts([os.path.abspath(__file__), os.path.join(PARENT, "exact_f27.py"),
                             os.path.join(PARENT, "foam_io_f27.py"), os.path.join(HERE, "build_f27_successor.py"),
