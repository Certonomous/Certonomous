...
(called by run_f27_successor.sh once per level; lineage build_f27.py, this repo).
IDENTICAL to the frozen parent build_f27.py EXCEPT the two CHANGED numerics
dictionaries (fvSchemes, fvSolution) are copied from the successor's OWN system/
(SUCC_SYSTEM) instead of the parent case; every OTHER file -- the unchanged
dictionaries and every template -- is taken from the frozen parent case UNCHANGED.
