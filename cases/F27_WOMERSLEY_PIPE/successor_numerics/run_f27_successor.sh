...
GRADER="$HERE/grade_f27_successor.py"
PROJ_MOD="$PARENT/proj_f27.py"                              # SHARED, unchanged
FIO="$PARENT/foam_io_f27.py"                                # SHARED, unchanged
RUN_ROOT="/home/ubuntu/Certonomous/verification/runs/F27_NUMERICS_SUCCESSOR_runs"
FOAM_BASHRC="/usr/lib/openfoam/openfoam2606/etc/bashrc"
STATUS="$HERE/STATUS.F27_NUMERICS_SUCCESSOR"
GRADER_REL="cases/F27_WOMERSLEY_PIPE/successor_numerics/grade_f27_successor.py"  # for the rule-2 blob hash

CAP_CORE_MIN=500            # HARD CAP; must equal grade_f27_successor.py::CAP_CORE_MIN and the pre-registration
