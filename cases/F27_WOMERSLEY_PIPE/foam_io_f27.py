#!/usr/bin/env python3
"""F27 -- minimal reader/writer for OpenFOAM ascii volVectorField / volScalarField
files (lineage: cases/F23_HP_WEDGE/foam_io_f23.py), used by
build_f27.py (to write 0/U = 0 from rest) and by
grade_f27.py (to read U at the graded instants and 0/C, 0/V).  Refusals are `raise`; zero
`assert` (L-332)."""
import re
