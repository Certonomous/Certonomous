...
**[WITHDRAWN 2026-08-10 — chief ruling `7abb0ba3`. The B-52 ladder's "turn" is withdrawn as a claim: the published −4.055e-3 is max(rung 6) − min(rung 7) of eight same-recipe draws, and re-estimated from all of them the rung 6→7 increment is +8.2e-5 ± 1.2e-3 (t = 0.071) — 49× smaller, opposite in sign, and smaller than the resolution-mismatch bias. A selected extremum is not a measurement. See `campaign/B52_TURN_WITHDRAWAL_2026-08-10.md`. Original text retained below.]** *The Ahmed 25° half is NOT withdrawn: it has a single replicate pair, exactly the standing the B-52's turn had before this measurement, and it is the open question this withdrawal leaves behind.* **[SUPERSEDED the same day, 2026-08-10, chief ruling `8f5bf878`: the Ahmed 25° turn IS now withdrawn too, on four draws at its previously untested c3 end. **Both** legs of this sentence's claim are gone; see `campaign/R4_AHMED_TURN_WITHDRAWAL_2026-08-10.md`. The open question it named was answered in hours, and answered against it.]**
