...
| 2D duct family (context for the 3D supersonic duct) | **F6c + closure line** | AR_1/AR_3/AR_14 are the closure challenge's ducts; QCR2000 built and scored (AR_1 0.0811→0.0455, AR_3 0.0775→0.0400, round-5 rank 1 locally — **P(rank 1) = 50%** against the **six**-entry LIVE board fetched 2026-08-11T23:33Z, **and eight cases cannot pin that tighter than 0–97% at 95% (double bootstrap); a one-seed draw moves it 34–65%, and its adverse leg puts us second** — and the lead is **not statistically decided** against Yang, Reissmann, Wu & Zhang or Tian/Buchanan/Hickel/Dwight, though it is against Liu and Montoya; the standing is three deletions wide and AR_1/AR_3 are ties below published precision. ~~P(rank 1) = 68%, 2–100% at 95%, a one-seed draw 52–81%, the standing two cases wide~~ — **STRUCK 2026-08-11: computed 2026-08-10 against a FOUR-entry board that no longer exists** (`campaign/BOARD_MOVED_2026-08-11.md`). Two prohibitions now, not one: **no surface states the figure without its interval, and none states it without its board** — see `campaign/PROBABILITY_OF_RANK_SIX_ENTRY_2026-08-11.md`, with the superseded computation kept at `campaign/PROBABILITY_OF_RANK_2026-08-10.md`.). All incompressible Re_τ 180/360. **The 3D supersonic square duct is genuinely new** — and it is the natural compressible test of the same QCR term. | `CLOSURE_CHALLENGE_STATUS.md` |
