...
# R17 (MOVE_MAP batch 5) moved every loose `*.json` out of the webroot to
# `research/closure/data/`, so this literal has been dangling since that
# batch landed and this measurement has been reading a file that is not
# there.  `lab_paths.web_file()` answers where the file is NOW, on either
# side of that move.
sys.path.insert(0, str(REPO / "scripts"))
import lab_paths as _lab_paths                                # noqa: E402
QCR = _lab_paths.web_file("closure_challenge_round5_qcr.json")
