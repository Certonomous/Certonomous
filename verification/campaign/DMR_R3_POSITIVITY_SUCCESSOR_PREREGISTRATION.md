...
3. if 1–2 are insufficient at 1/240, **`Gauss Minmod` on the energy/velocity
   reconstruction specifically** with the interpolation applied to primitive rather
   than conservative variables (documented rhoCentralFoam robustness practice).
