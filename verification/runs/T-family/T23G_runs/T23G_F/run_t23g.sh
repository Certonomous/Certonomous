#!/bin/bash
# T23G level T23G_F -- DETACHED LAUNCHER.  Serial, 1 rank.
# CAP (CLAUDE.md rule 12, T23G section 8.2): the timeout IS the cap.  An overrun
# STOPS the run; it does not get a new budget.
set -u

CASE="/home/ubuntu/Certonomous/verification/runs/T-family/T23G_runs/T23G_F"
NAME="T23G_F"
RANKS=1
TIMEOUT_S=24000           # cap 400.0 core-min at 1 rank
...
# can still mean something; measured after the fact it proves nothing.
{
    ...
    echo "cap_core_min=400.0"
    echo "point_core_min=120.88"
