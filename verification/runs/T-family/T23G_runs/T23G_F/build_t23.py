...
# ----------------------------------------------------------------- mesh (L1)
NR_BL_IN, GR_BL_IN = 80, 40.0     # fluid inner BL, T23G_F level: 80 cells, last/first = 40
NR_MID, GR_MID = 80, 1.0          # fluid core band
NR_BL_OUT, GR_BL_OUT = 60, 1.0 / 40.0   # fluid outer BL, contracting to the duct wall
NR_HOUS = 16                       # housing, radial (directive 3.5 asks >= 8; the COARSE arm of a ladder is deliberately below it)
NR_CORE = 48
NZ_UP, NZ_MID, NZ_DOWN = 160, 280, 200
