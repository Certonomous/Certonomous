#!/usr/bin/env python3
"""T19 -- the FROZEN comparator.  Fully developed laminar forced convection
...
def load_registered(root=None):
    p = os.path.join(root or HERE, "T19_registered.json")
...
def main():
    ...
    ap.add_argument("--json", default=os.path.join(HERE, "gate_t19.json"))
    a = ap.parse_args()
    if a.selftest:
        return selftest()
