#!/usr/bin/env python3
"""build_t3e.py -- build R_fy, the T3e continuation of R_fx.
...
THIS BUILDER'S CONTRACT (T3e_PREREGISTRATION.md section 7.2): R_fy/CASE.txt
...
SRC_CASE = "R_fx"          # the completed predecessor
SRC_TIME = "24000"         # its endTime, reconstructed
DST_CASE = "R_fy"
...
def main():
    ...
    lines = ["case              %s" % DST_CASE,
             "rung              T3e (heated backward-facing step, continuation of %s)" % SRC_CASE,
             "level             fy",
             "arm               continuation"]
    ...
    lines += ["endTime           %d" % ADDITIONAL_ITERATIONS,
              ...
              "registration      docs/campaigns/T-family/T3e_PREREGISTRATION.md",
              "",
