#!/usr/bin/env python3
"""P1B — ARM P1B, NOT P1.  Split L2's single `defaultFaces` patch into wing / farfield / symmetry.
...
Y_SYMM_TOL = 1.0e-3     # ARM P1B. Registered in ADDENDUM 1 (2026-09-12) of
                        # CRM_WINGALONE_FLOW_PREREGISTRATION.md, derived from the GAP the
                        # P1B band sweep measures and NOT from the count it produces:
                        # 105.4x above the last root-plane face (max|y| 9.491133e-06) and
                        # 3767x below the first contaminant (|y| 3.766668), in a gap
                        # spanning 396,862x.  P1 used 1e-9 and GATE FAILed; that arm is
                        # STRUCK BUT LEGIBLE and is NOT rehabilitated by this one.
# ---------------------------------------------------------------------------
