...
R=/home/ubuntu/Certonomous/verification/runs/DMR_R3_STEP0_DIAG_v2_runs
CASE="$R/STEP0"
...
# `-u` dropped around the source ONLY (L-339: the bashrc reads an unbound
# WM_PROJECT_DIR at its line 184 and would kill this shell silently).  USER
# exported first (L-343: a cron-started queue runner carries no USER).
