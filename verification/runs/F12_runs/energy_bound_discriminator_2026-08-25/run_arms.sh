...
# ADDENDUM 1 (2026-08-25) landed at e46d844c, appending 69 lines at the FOOT.
# The guard below is STRENGTHENED, NEVER WEAKENED: it now pins the FROZEN BODY
# (lines 1-478, the text as committed at 54acad46) byte-for-byte AND still
# requires the whole file on disk to equal HEAD. Any edit ABOVE the addendum
# changes the frozen-body sha and this script REFUSES. A guard that can be
# switched off when it fires is not a guard.
PREREG_FROZEN_BODY_LINES=478
PREREG_FROZEN_BODY_SHA=23c3e4524cf11301ff2e9e38dc2d9de1b3caad77e49f7ba1c940a8dab7790ca3
PREREG_SHA=82dbd335c034cb8e07eff6070227e8142bcf4055864e244a7fb79d3f7c8bfecf
PREREG_BLOB=1ee9f1d0
...
echo "FREEZE OK  frozen body (1-$PREREG_FROZEN_BODY_LINES) $BODY | whole file $GOT | HEAD blob $BLOB" | tee $REC/evidence/freeze_verified.txt
