...
adversely moves P(rank 1) from 68\% to \textbf{52\%} (favourably, to 80.5\%). The internal
...
\item[The hump remains open, honestly named.] Its adjoint blocker is Krylov convergence
  rate against a memory envelope rather than a singular factorisation; a Richardson-wrapped
  configuration capping the restart basis is staged and unrun. Its \emph{entry} blocker is
