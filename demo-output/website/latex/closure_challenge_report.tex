...
re-solved with the correction folded in.} In the Duraisamy--Iaccarino--Xiao taxonomy this
is the ``correct the answer'' family, structurally distinct from FIML, TBNN, SpaRTA and
eigenvalue perturbation, all of which correct something inside the equations before
re-solving (\artifact{docs/research/CLOSURE\_METHODS.md};
\artifact{CLOSURE\_CHALLENGE\_STATUS.md} \S4, commit \code{b9cb56a2}).
...
\item \textbf{It is not novel, and the nearest prior art is by the challenge's own
  authors.} Classifier-controlled data-driven corrections are established: Ling \&
  Templeton, \emph{Phys.\ Fluids} 27, 085103 (2015); Wu, Wang, Xiao \& Ling,
  \emph{Flow Turbul.\ Combust.} 99, 25 (2017), DOI 10.1007/s10494-017-9807-0; Steiner,
...
submitters to preview their score. No public statement of ours may imply otherwise.
...
the measured seed-uncertainty qualifier on the rank-2 gap; and the prior art on
classifier-controlled corrections, with no sentence presenting confidence-gated correction
as novel.
...
Prior art on classifier-controlled corrections \\
