...
probability is \textbf{P(rank 1) = 68\%, and eight cases cannot pin that tighter than
2--100\% at 95\%}, with the lead over the rank-2 entry
\textbf{not statistically decided} (Table~\ref{tab:prank}). The submission package exists,
...
\textbf{P(rank 1) = 68\%} --- 2--100\% at 95\%, the width eight cases support --- and the two
...
\textbf{P(rank 1) = 68\%} (67.6\%), which eight cases cannot pin tighter than
\textbf{2--100\% at 95\%} --- the full ladder of intervals is unpacked immediately after
Table~\ref{tab:prank}, and the figure does not travel anywhere without one of them.
The rest of the distribution is not a rounding error:
rank~2 at 18.6\% and rank~3 at 12.8\%.
...
Read in the order of increasing honesty. The Monte Carlo interval (67.5--67.8\%) measures only
that the resampling ran long enough. Leave-one-case-out across eight refits gives 38--91\%, and
a double bootstrap gives 26--94\% at the 68\% level and 2--100\% at 95\%. \textbf{Eight cases
cannot resolve a probability of rank better than ``somewhere between a coin flip and near
...
on the three seed-dependent cases is 0.0024 against a rank-1 margin of 0.002878, and loading it
adversely moves P(rank 1) from 68\% to \textbf{52\%} (favourably, to 80.5\%). The honest
...
never without its interval.} \textbf{P(rank 1) = 68\%}, which eight cases cannot pin
tighter than \textbf{2--100\% at 95\%}; the leads over Reissmann and over Wu \& Zhang are
\textbf{not statistically decided} (Table~\ref{tab:prank}). \emph{Until 2026-08-10 this item
