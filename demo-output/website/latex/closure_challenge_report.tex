...
says \emph{rank 1} it means rank 1 on that local scoring. The submission package exists,
...
and is stated with that caveat everywhere it appears in this report. The entry is now
...
ranks are the board's own; ours is where our number falls in it.}
\label{tab:board}
\begin{tabular}{clc}
\toprule
Rank & Entry & Overall \\
...
\item \textbf{The pre-stated expectation band was wrong in our favour, and that is recorded
  ...
  best end, a regression at its worst. The result landed at 0.056647, \emph{below the good
...
are the entry of record; round 2 is omitted for width and appears in \S3.1.}
\label{tab:percase}
\resizebox{\textwidth}{!}{%
...
\midrule
\textbf{Overall} & \textbf{0.1036} & \textbf{0.0676} & \textbf{0.0654} & \textbf{0.056647} & \textbf{0.0595} & --- & rank 1 of 5, scored locally \\
\bottomrule
\end{tabular}}
\end{table}
