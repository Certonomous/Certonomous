...
- Extended-iteration divergence test (`f5c_extended_simplec20k`, coarse mesh, 20,000 iterations vs. the 8,000 already on record, PID 407308): RSS flat at ~80 MB and no NaN/divergence signature through iteration 7,371 of 20,000 (last check, this test was left running per instruction and is *not* load-bearing for this conclusion — it is corroborating, not causal).
