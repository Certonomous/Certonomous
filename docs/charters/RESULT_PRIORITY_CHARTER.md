...
This charter remains a draft (v0.5) awaiting the owner's ruling; this
addendum does not settle it and moves no version literal. The convention is
in force regardless, as `CLAUDE.md` rule 16.
