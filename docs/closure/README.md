...
| **`Kaandorp2020_TBRF`** | **in progress — preregistered, run, ungraded** | **No `RESULTS.md` exists.** Outputs are on disk at `/home/ubuntu/closure-data/kaandorp_tbrf/`. The only published account is second-hand, in `Ling2016_TBNN/RESULTS.md` §7b-i. Also carries `INCIDENT_tbrf_overwrite_2026-08-20.md` (charter §14). **This is the lane's open hole.** |
