...
- **LIVE:** 0 — VMFL046-R5 GRADED 2026-09-07 `NOT A RESULT` (register row #62): the shock
  **washed out** because `waveTransmissive lInf 2.0` un-anchored the back-pressure (outlet p
  ...
  capability gap.
- **REGISTERED (successor dir exists):** 6 — VMFL007-R2 → `VMFL007-R3`; VMFL011-R2 → `VMFL011-R3`;
...
- **OWED-DATED-PLAN (next attempt registered here):** 13 — the four VMFL046 lineage rows
  ...
  **VMFL046-R6**, dated 2026-09-07) plus the nine dated 2026-09-06: VMFL003-M2,
  VMFL011-R3, VMFL017-R2, VMFL022, VMFL063, VMFL072-R2,
