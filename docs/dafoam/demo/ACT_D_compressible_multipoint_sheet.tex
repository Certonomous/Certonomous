...
\vspace{1pt}
{\scriptsize The optimiser printed its own convergence statement and stopped
a quarter of the way into its budget. The improvement threshold is an input it
...
$\bullet$ One grid, $4\,032$ cells, one core. The grid convergence study for
this case is running; the band lands in your inbox with the certificate.\\
