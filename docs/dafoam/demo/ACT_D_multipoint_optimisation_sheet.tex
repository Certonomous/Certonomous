...
\vspace{1pt}
{\scriptsize The optimiser printed its own convergence statement against its
own tolerance. It stopped one fifth of the way into the iteration budget.}
\end{minipage}\hfill
\begin{minipage}[t]{0.475\textwidth}
...
$\bullet$ One grid, $4\,032$ cells. The grid convergence study for this case
is running; the band lands in your inbox with the certificate.\\
