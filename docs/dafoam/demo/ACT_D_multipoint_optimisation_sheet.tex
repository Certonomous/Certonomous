...
Far field radius              & $18.7$              & m               & measured \\
...
$5\,\mathrm{m}$; the far field reaches $18.7\,\mathrm{m}$.}
...
\textbf{Table 6. Compute: what we said, and what it cost.}

\vspace{1.5pt}
{\fontsize{6.7}{7.9}\selectfont
\begin{tabular}{@{}l r r r@{}}
\toprule
Stage & \begin{tabular}{@{}r@{}}Said,\\ core-min\end{tabular}
      & \begin{tabular}{@{}r@{}}Cost,\\ core-min\end{tabular}
      & \begin{tabular}{@{}r@{}}Cost /\\ said\end{tabular} \\
\midrule
Geometry and grid           & $0.19$  & $0.167$  & $0.88$ \\
Optimisation, 10 majors     & $103.0$ & $6.950$  & $\mathbf{0.07}$ \\
...
\vspace{1pt}
{\scriptsize The whole run is $851$ seconds, $14.2$ minutes on one core.
Derived cost \$$0.0121$ at \$$0.0513$ per core-hour, derived rather than
metered. The optimisation costs a fourteenth of what we quoted: we priced the
optimiser at its fifty iteration budget and it converged in ten.}
