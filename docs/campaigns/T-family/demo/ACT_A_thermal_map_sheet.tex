...
% -------------------------------------------------------------- cost --------
\vspace{2pt}
{\footnotesize\textbf{Compute.} 16 points $\cdot$ 1 rank each $\cdot$
\textbf{578.8 core-min actual against 483.6 forecast, ratio 1.20} $\cdot$
1\,h\,26\,min elapsed across two concurrent batches $\cdot$ $\$0.49$ at
$\$0.0513$ per core-hour, derived not measured.}
