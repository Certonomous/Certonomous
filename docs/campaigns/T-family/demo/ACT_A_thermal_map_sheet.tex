...
% -------------------------------------------------------------- cost --------
\vspace{2pt}
{\footnotesize\textbf{Compute.} Costed in two phases, and reported as two
because no combined estimate was ever fixed. \emph{First four points, four at a
time:} estimate $123.2$ core-minutes, used $120.1$, ratio $0.98$.
\emph{Remaining twelve, twelve at a time on one sixteen-core machine:} estimate
$360.4$, used $457.1$, ratio $1.27$. Total used $577.2$ core-minutes. The
overrun is entirely in the second phase and it is machine sharing --- that
estimate was calibrated at four-at-once. Derived cost $\$0.49$ at $\$0.0513$ per
core-hour; the rate is stated by the machine's owner, not metered on the
machine.}
