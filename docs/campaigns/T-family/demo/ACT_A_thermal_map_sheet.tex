...
\midrule
%<<ACTA t1>>
\textbf{80} & 39.2 & 30.2 & 26.6 & 24.7 & not quantified (single mesh level) \\
\textbf{155} & 62.0 & 44.5 & 37.6 & 33.8 & not quantified (single mesh level) \\
\textbf{230} & 84.9 & 58.8 & 48.6 & 42.9 & not quantified (single mesh level) \\
\textbf{305} & 107.7 & 73.1 & 59.6 & 52.0 & not quantified (single mesh level) \\
%<<END t1>>
\bottomrule
\end{tabular}
...
\midrule
%<<ACTA t2>>
80 & 39.2 & 38.1 & 1.1 & 160.8 & clears the limit \\
155 & 62.0 & 60.0 & 2.1 & 138.0 & clears the limit \\
230 & 84.9 & 81.8 & 3.1 & 115.1 & clears the limit \\
\textbf{305} & \textbf{107.7} & \textbf{103.6} & \textbf{4.1} & \textbf{92.3} & worst solved point \\
%<<END t2>>
\bottomrule
\end{tabular}}

\vspace{1pt}
{\footnotesize Cells are rounded independently; differences may not match to
the last digit.}

\vspace{1.5pt}
%<<ACTA coolest>>
{\footnotesize Coolest core peak 24.7$\,^{\circ}\mathrm{C}$, at
...
\midrule
%<<ACTA t3>>
10 & 329.1 & 195.1 & 103.6 & \textbf{3.541} & \textbf{2.031} \\
20 & 197.3 & 120.3 & 69.0 & 3.369 & 1.947 \\
30 & 148.0 & 92.4 & 55.4 & 3.280 & 1.911 \\
40 & 121.6 & 77.4 & 47.8 & \textbf{3.235} & \textbf{1.896} \\
%<<END t3>>
\bottomrule
\end{tabular}}
...
% -------------------------------------------------------------- cost --------
\vspace{2pt}
{\footnotesize\textbf{Compute.} Predicted before solving:
\textbf{483.6 core-min}, 16 points at 1 rank. Actual: \textbf{578.8 core-min,
ratio 1.20, within 20\% of prediction, OVER} $\cdot$ 1\,h\,26\,min elapsed,
two concurrent batches $\cdot$ $\$0.49$ at $\$0.0513$ per core-hour, derived
not measured.}
