...
% -------------------------------------------------------------- cost --------
\vspace{2pt}
{\footnotesize\textbf{Compute.} Sixteen operating points, solved in two
concurrent batches. Time spent solving: 1\,h\,26\,min. Cost $\$0.49$, derived
at $\$0.0513$ per core-hour. The rate is stated by the machine's owner rather
than metered here.}
