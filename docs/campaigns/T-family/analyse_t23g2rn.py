...
GRADING_PATH_FREEZE_COMMIT = "PIN-AT-FREEZE"  # DRAFT (T23G2Rn): the supervisor pins the freeze commit at freeze (rule 2). While this reads "PIN-AT-FREEZE" verify_self() REFUSES to grade.
