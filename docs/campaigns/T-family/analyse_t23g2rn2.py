...
GRADING_PATH_FREEZE_COMMIT = "9ff293229ce6c0a60c9381be50fdf129b1d2199a"  # freeze commit 1/2 (T23G2Rn2); this line set in commit 2/2 (VERIFICATION_CHARTER.md §2au.2). SELF member print-only (EXPECTED_SELF_BLOB=None), anchored by the FREEZE-PIN line in commit 2/2's message + grade-time byte-identity.
