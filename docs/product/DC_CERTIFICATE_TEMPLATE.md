...
| **conjugate interface temperature, hot interface** | **T9a R1**, wall `T` interface 1 [K] | **GATE FAIL** | 348.778673 vs exact 348.781082 — **−2.41 mK against a 0.92 mK GCI band** (0.00069 % vs 0.00026 %), triple CONVERGING at `p` 1.738 | **H-4 diagnosis arm**: interface scheme vs mesh vs property jump, one change per run. PENDING |
